...
<div class="hero-wrap" style="background-image: url('siteassets/images/bg_7.jpg');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
          <div class="row d-flex">
              <div class="col-md-6 d-flex ftco-animate">
                  <div class="img img-about align-self-stretch" style="background-image: url(siteassets/images/cheerfu4.jpg); width: 100%;"></div>
              </div>
    ...
    <div class="container">
      ...
      <div class="row">
          <div class="col-lg-4 d-flex mb-sm-4 ftco-animate">
              <div class="staff">
                  <div class="d-flex mb-4">
                      <div class="img" style="background-image: url(siteassets/images/person_1.jpg);"></div>
                      <div class="info ml-4">
                          <h3><a href="{{ URL('teacher-single.html') }}">Ivan Jacobson</a></h3>
          ...
          <div class="col-lg-4 d-flex mb-sm-4 ftco-animate">
              <div class="staff">
                  <div class="d-flex mb-4">
                      <div class="img" style="background-image: url(siteassets/images/person_2.jpg);"></div>
                      <div class="info ml-4">
                          <h3><a href="{{ URL('teacher-single.html') }}">Ivan Jacobson</a></h3>
                          <span class="position">Donated Just now</span>
                          <div class="text">
              ...
              <div class="staff">
                  <div class="d-flex mb-4">
                      ...
                      <div class="info ml-4">
                          ...
                          <span class="position">Volunteer on IT Services.</span>
                          <div class="text">
